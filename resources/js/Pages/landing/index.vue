            ...
            <BContainer>
                ...
                <BCollapse class="navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mx-auto mt-2 mt-lg-0" id="navbar-example">
                        <li class="nav-item">
                            <a class="nav-link" to="#hero" @click.prevent="scrollToSection('hero')">Home</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" to="#services" @click.prevent="scrollToSection('services')">Services</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" to="#features" @click.prevent="scrollToSection('features')">Features</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" to="#plans" @click.prevent="scrollToSection('plans')">Plans</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" to="#reviews" @click.prevent="scrollToSection('reviews')">Reviews</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" to="#team" @click.prevent="scrollToSection('team')">Team</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" to="#contact" @click.prevent="scrollToSection('contact')">Contact</a>
                        </li>
                    </ul>
                ...
                <BRow class="justify-content-center">
                    <BCol lg="8" sm="10">
                        <div class="text-center mt-lg-5 pt-5">
                            <h1 class="display-6 fw-semibold mb-3 lh-base">Amplify Your Digital Presence with
        ...
        <section class="py-5 bg-primary position-relative">
            ...
            <BContainer>
                <BRow class="align-items-center gy-4">
                    ...
                    <BCol sm="auto">
                        <div>
                            <Link href="https://1.envato.market/velzon-admin" target="_blank"
                        ...
                        <BCard no-body class="plan-box mb-0">
                            <BCardBody class="p-4 m-2">
                                ...
                                <div>
                                    ...
                                    <div class="mt-4">
                                        <BLink href="javascript:void(0);" class="btn btn-soft-success w-100">Get
                                            Started</BLink>
                                    </div>
                                </div>
                            </BCardBody>
